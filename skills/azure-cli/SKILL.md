...
python3 /home/bc/models/mistral.py "Your prompt here"

# Call Kimi K2 Thinking  
python3 /home/bc/models/kimi.py "Your prompt here"
```
...
The scripts in `/home/bc/models/` provide seamless access to your Mistral and Kimi deployments.
